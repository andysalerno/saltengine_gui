// use super::{bi_channel::BiChannel, messages::ToGui};
// use crate::agent::{gui_agent::GuiAgent, messages::FromGui};
// use log::info;
...
// pub(crate) fn run(local_channel: BiChannel<ToGui, FromGui>) -> Result<()> {
//     smol::block_on(async {
...
//         handle_connection(connection, local_channel).await
//     })
// }

// async fn handle_connection(
//     mut connection: Connection,
//     local_channel: BiChannel<ToGui, FromGui>,
// ) -> Result<()> {
//     // Expect a Hello
//     info!("Connected.");
...
//     let mut agent: Box<dyn GameAgent> = Box::new(GuiAgent::new_with_id(local_channel, my_id));
